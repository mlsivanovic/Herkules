...
- **Training plans** — named, ordered sets of routines. Seven starter programs install from Routines: **Hybrid 4-day V2.1** (flagship gym + tendon), Foundations, Home, **Street** (bars, bodyweight, optional ≤15 kg dumbbells), Busy, Build, and Longevity. Hybrid still upgrades recognized older plans idempotently while preserving routine IDs and historical workout snapshots
