...
- **Training plans** — named, ordered sets of routines. **Hybrid 4-day V2.1** installs directly as A–D (back squat, trap bar, dips, TRX) and upgrades recognized older Hybrid plans idempotently while preserving routine IDs and historical workout snapshots
